...
namespace adressBook.BL.Repository
{
    public class UserRep : IUserRep
    {
        ...
        public async Task<ContactPerson> UpdateUser(EditUserVM editUserVM)
        {
            var user = await db.ContactPeople.FindAsync(editUserVM.ID);

            user.Address = editUserVM.Address;
            user.DateOfBirth = editUserVM.DateOfBirth;
            user.DepID = editUserVM.DepID;
            user.Email = editUserVM.Email;
            user.FullName = editUserVM.FullName;
            user.HomeTelNo = editUserVM.HomeTelNo;
            user.MobileNo = editUserVM.MobileNo;
