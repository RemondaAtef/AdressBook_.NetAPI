...
namespace adressBook.BL.Repository
{
    public class UserRep : IUserRep
    {
        ...
        public async Task UpdateUser(ContactPerson contactPerson)
        {
            ...
            else if (user != null && contactPerson.Address != null && contactPerson.DateOfBirth == null && contactPerson.Email == null && contactPerson.HomeTelNo == null && contactPerson.MobileNo == null)
            {
                user.Address = contactPerson.Address;
